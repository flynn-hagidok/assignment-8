    ...
    return (
        <div className="text-black mt-8 text-center text-white">
            <div className="flex flex-col items-center px-2 lg:px-0">
                <h2 className="font-bold text-[4rem] lg:text-[4.5rem]">We Build<br /> <span className="bg-gradient-to-r from-[#632EE3] to-[#9F62F2] bg-clip-text text-transparent">Productivity</span> Apps</h2>
            ...
            <div className="bg-gradient-to-r from-[#632EE3] to-[#9F62F2] bg- py-10">
                <h2 className="text-[2.5rem] lg:text-[3rem] font-bold">Trusted By Millions, Built For You</h2>
                <div className="lg:flex justify-center items-center gap-50 mt-10">
                    <div>
                        <p>Total Downloads</p>
                        <h2 className="text-[3rem] lg:text-[4rem] font-extrabold">29.6M</h2>
                        <p>21% More Than Last Month</p>
                    </div>
                    <div>
                        <p>Total Reviews</p>
                        <h2 className="text-[3rem] lg:text-[4rem] font-extrabold">906K</h2>
                        <p>46% More Than Last Month</p>
                    </div>
                    <div>
                        <p>Active Apps</p>
                        <h2 className="text-[3rem] lg:text-[4rem] font-extrabold">132+</h2>
